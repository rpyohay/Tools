...
mylist = FileUtils.loadListFromFile('/afs/cern.ch/user/k/ktos/NMSSM_Analysis/CMSSW_7_4_12_patch4/src/BoostedTauAnalysis/CleanJets/FileLists/inFileList_BBA_a30_NUM.txt')
